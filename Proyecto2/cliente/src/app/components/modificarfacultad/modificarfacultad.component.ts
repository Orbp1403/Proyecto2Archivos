...
@Component({
  selector: 'app-modificarfacultad',
  templateUrl: './modificarfacultad.component.html',
  styleUrls: ['./modificarfacultad.component.css']
})
export class ModificarfacultadComponent implements OnInit {
